...
static void drawFan(struct turbines turbine)
{
   ...
   glColor3f(1,1,1);
   drawBlades(0, 100, 10, 50, turbine.size, 1 / (10 *turbine.size));
   //glRotatef(90, 0, 1, 0);
   glPopMatrix();
}
...
*/
   ...
   if (light)
   {
      ...
      Print("Wind Angle =%d Wind Speed = %.0f", temp2, speedWind);
      //glWindowPos2i(5,25);
...
void idle()
{
   double t = glutGet(GLUT_ELAPSED_TIME)/2500.0;
   zh = fmod(90*t,360);
